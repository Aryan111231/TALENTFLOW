    ...
    try {
      ...
      if (jobCount === 0) {
        ...
        for (const job of allJobs) {
          ...
          console.log(
            `Assessment for "${job.title.slice(0, 40)}..." (${totalQuestions} questions)`
          );
        }
        ...
        if (!import.meta.env.DEV) {
          alert(
            `Database seeded! ${finalStats.jobs} jobs (all with assessments), ${finalStats.candidates} candidates created.`
          );
        }
      } else {
